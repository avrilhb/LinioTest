package com.example.avril.liniotest.webClient;

import android.util.Log;

import com.example.avril.liniotest.application.LinioApplication;
...
public class WSClient {
    ...
    public Object WSClientConsumerBasic(String url, String params, String method)
            throws Exception {
        String URL_SERVER = LinioApplication.URL_BASE;
        String dataBack = "";
        String urlConnect = "";
